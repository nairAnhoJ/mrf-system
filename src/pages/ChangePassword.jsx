            ...
            <div className='w-screen h-screen flex items-center justify-center bg-gray-200'>
                <form onSubmit={handleSubmit} className='bg-white rounded w-[400px] p-6 text-gray-600 shadow-xl'>
                    ...
                    <div className='relative pb-3'>
                        ...
                        <input type="password" value={data.password} onChange={(e) => setData({...data, password: e.target.value})} className='border w-full pb-2 pt-3 rounded border-gray-300 pl-9 font-semibold text-gray-600' placeholder='New Password' autoComplete='off'/>
                        {
                    ...
                    <div className='relative'>
                        <IconRenderer name={'password'} className={'absolute top-[11px] left-[9px] w-6 h-6'} />
                        <input type="password" value={data.password_confirmation} onChange={(e) => setData({...data, password_confirmation: e.target.value})} className='border w-full pb-2 pt-3 rounded border-gray-300 pl-9 font-semibold text-gray-600' placeholder='Confirm New Password' autoComplete='off'/>
                        {
                    ...
                    <div>
                        <button type='submit' className='w-full mt-5 border py-2 rounded font-bold text-white bg-blue-600 tracking-wider shadow-lg'>SUBMIT</button>
                    </div>
                </form>
            </div>
        </>
