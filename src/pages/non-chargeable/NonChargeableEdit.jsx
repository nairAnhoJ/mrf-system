...
import { getByFleetNumber, update as requestUpdate, getById, getByRequestId } from '../../services/nonChargeableService'
...
const NonChargeableEdit = () => {
    ...
    const getItem = async() => {
        ...
        try {
            ...
            setFsrrPreview(baseURL + '/MRF/'+response[0].fsrr_attachment);
            setPmPreview(baseURL + '/MRF/'+response[0].pm_attachment);
...
export default NonChargeableEdit